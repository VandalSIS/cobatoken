...
const keyPoints = [
  {
    ...
    description: 'Определяет отношения между вами и платформой COBA токен.',
  },
  {
    icon: Shield,
          ...
          <div className="space-y-8">
            ...
            <Card>
              ...
              <CardContent className="prose dark:prose-invert max-w-none">
                <p>
                  Настоящие Условия представляют собой юридически обязательное соглашение между вами и COBA относительно вашего использования нашего веб-сайта, платформы и услуг, связанных с токенами COBA.
                </p>
                <p>
            ...
            <Card>
              ...
              <CardContent className="prose dark:prose-invert max-w-none">
                <ul>
                  <li><strong>"COBA":</strong> Токен ERC-20, выпущенный нашей компанией, обеспеченный финансовыми резервами.</li>
                  <li><strong>"Платформа":</strong> Наш веб-сайт, приложения и связанные услуги</li>
                  <li><strong>"Пользователь" или "Вы":</strong> Любое физическое или юридическое лицо, использующее услуги, предоставляемые COBA, включая обмен токенов и связанную с этим деятельность.</li>
                  <li><strong>"Услуги":</strong> Все услуги, предоставляемые COBA, включая обмен токенов и связанную деятельность</li>
                  <li><strong>"Резервы":</strong> СОВА пополняет и поддерживает финансовые резервы.</li>
                  <li><strong>"KYC":</strong> Процедуры проверки "Знай своего клиента"</li>
                  <li><strong>"AML":</strong> Поддерживает требования соответствия по борьбе с отмыванием денег.</li>
                </ul>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="prose dark:prose-invert max-w-none">
                <p className="font-bold text-red-600 dark:text-red-400">
                  ВАЖНО: Инвестиции в другие криптовалюты несут значительные риски. Вы должны тщательно рассмотреть эти
                  риски перед покупкой токенов:
                </p>

                <h4>Рыночные риски</h4>
                <ul>
                  <li>Стоимость других токенов может значительно колебаться.</li>
                  <li>Цены на золото в меньшей степени подвержены рыночной волатильности</li>
                  <li>Ликвидность может быть ограничена при определенных рыночных условиях.</li>
                  <li>Обмен может быть приостановлен во время экстремальных рыночных событий.</li>
                </ul>

                <h4>Технологические риски</h4>
                <ul>
                  <li>Технология блокчейн относительно нова и развивается.</li>
                  <li>Другие смарт-контракты могут содержать ошибки или уязвимости.</li>
                ...
                <ul>
                  ...
                  <li>Некоторые юрисдикции могут запретить деятельность, связанную с криптовалютой.</li>
            ...
            <Card>
              ...
              <CardContent className="prose dark:prose-invert max-w-none">
                <p>
                  ...
                  нашей платформе принадлежат COBA токен или лицензированы нами. Вы не можете использовать, 
            ...
            <Card>
              ...
              <CardContent className="prose dark:prose-invert max-w-none">
                <p className="font-bold uppercase">
                  В МАКСИМАЛЬНОЙ СТЕПЕНИ, РАЗРЕШЕННОЙ ЗАКОНОМ, COBA ТОКЕН НЕ НЕСЕТ ОТВЕТСТВЕННОСТИ ЗА ЛЮБЫЕ 
            ...
            <Card>
              ...
              <CardContent className="prose dark:prose-invert max-w-none">
                <p>
                  Мы можем прекратить или приостановить доступ к нашим услугам в любое время, с причиной или без, с уведомлением или без него. После прекращения ваше право на использование наших услуг немедленно прекращается.
                </p>
                <p>
                  Вы можете прекратить свои действия в любое время, следуя процедуре закрытия на нашей платформе.
                </p>
              </CardContent>
            </Card>
